...
\begin{document}
	...
	\begin{resume}
		...
		% -------------------------------------------------------- 
		\section{Skills}
		{\sl Deep Learning, Machine Learning and Datamining: }Big Data Analysis using Google TensorFlow, WEKA in JAVA, Rapid Miner, Clementine, Theano, Caffee, and also fMRI \& DTI brain image analysis.\\

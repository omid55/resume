...
\begin{document}
	...
	\begin{resume}
		...
		% --------------------------------------------------------
		\section{Objective}
		To obtain an intern position in industry utilizing my strong programming background and 2 years experiences in software development. Passionate to work in a team on challenging problems related to machine learning.
